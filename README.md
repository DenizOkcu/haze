...
- **Unified config pickers.** `/provider`, `/lsp`, `/mcp`, and `/skills` are interactive pickers with autocomplete, presets, and masked API-key entry where applicable, replacing the old subcommand syntax.
