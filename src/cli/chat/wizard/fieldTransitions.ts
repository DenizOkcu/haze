...
import {captureMcpCommand, captureMcpName, captureMcpTransport, captureMcpUrl, captureProviderName, captureProviderUrl} from '../../commands/wizardFlow.js';

/** Pure field-transition steps (provider/MCP add flows), applied at the submit boundary. */
